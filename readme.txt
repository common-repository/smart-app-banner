...
Tags: ios, iphone, ipad, banner, apple
...
[iTunes Link Maker](https://itunes.apple.com/linkmaker/) or if the iTunes URL for your
app looks like this:

https://itunes.apple.com/us/app/rootn-tootn-baby-feed-timer/id530589336?ls=1&mt=8
...
It's only available on devices with iOS 6 or later. if you want to check that it's working and you
...
I quick thanks is always appreciated! Recommending the plugin is good and I'm always happy
to receive fixes and improvements.
...
= 1.1.6 =
* More fixes for deployments on PHP 8.x
* More general code quality enhancements

= 1.1.5 =
* Fix for warnings when deployed on PHP 8.x
* General code quality enhancements

= 1.1.4 =
* Improve input validation (CVE-2023-46200)
* Remove references to Wandle Software

= 1.1.3 =
* Fix for CSRF vulnerability

= 1.1.2 =
* Fix for undefined variables warning, contrinuted by @craigiswayne.

= 1.1.1 =
* Fix for dropdown app list on Chrome
...
* Translation into Serbo-Croation (sr_RS) thanks to [Borisa Djuraskovic](https://www.webhostinghub.com/)
